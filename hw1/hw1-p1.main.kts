...
// accepts an integer, increases the number by one, and outputs the perfect square
...
fun perfectDescription(number: Int): String {
    return "perfect square $number is ${kthPerfectSquare(number)}"
}
