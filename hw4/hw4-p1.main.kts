...
// represents a student with a first name, last name, and id
...
// accepts a list of students and a function, then performs that function on each student in the list
fun myForEachDo(
...
// accepts a string and returns a boolean cooresponding to whether or not the string is a palindrome
// does this by comparing the first letter to the last letter, then moving inwards towards (and past) the center of the string
...
// accepts an integer, and uses nested for loops to print a triangle made of asterisks
// outer for loop is used to add lines and iterate through lines; inner one is used to print correct amount of stars per line
